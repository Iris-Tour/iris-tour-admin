...
interface MultipleSelectorProps {
    ...
    /** Custom render function for badges */
    renderBadge?: (
        option: Option,
        ...
        >
            ...
            >
                <div className="flex flex-wrap gap-1">
                    {selected.map((option) => {
                        if (renderBadge) {
                            return renderBadge(option, handleUnselect);
                        }
                        return (
                            <div
                                key={option.value}
                    ...
                    <CommandPrimitive.Input
                        ...
                        className={cn(
                            "flex placeholder:text-muted-foreground/70 flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed ",
                            {
                                "w-full": hidePlaceholderWhenSelected,
                                "px-4 py-3": selected.length === 0,
